    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo - Home Navigation - Increased Size */}
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            {/* Search with Suggestions - Hidden on small screens */}
            ...
            {isAuthenticated ? (
              ...
              <div className="flex items-center space-x-2">
                ...
                <Link to="/register">
                  <EdumallButton variant="primary" size="sm" className="bg-gradient-to-r from-teal-500 to-blue-600 hover:from-teal-600 hover:to-blue-700">
      ...
      {isLoggingOut && (
        <PreLoader isLoading={isLoggingOut} message="Signing out..." type="logout" />
      )}
    </motion.nav>
  );
};
